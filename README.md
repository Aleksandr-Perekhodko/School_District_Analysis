...
## Summary
With changing the ninth grae rading and math scores changed to NaNs the there is going to be major changes to the code when looking at the data frames since the output will have the ninth grades having NaNs instead of grades. The overall percentage of passing of the Thomas High School have significantly decreased by 25.87%, which in turn will significantly decrease the school performance ranking.
